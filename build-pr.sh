...
nix-shell -p nixpkgs-review --run "nixpkgs-review pr --extra-nixpkgs-config '{ allowInsecurePredicate = x: true; }' --eval local --build-args='$*' --no-shell --print-result 292611" || true
